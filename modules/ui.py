...
def list_interface_input_elements(chat=False):
    ...
    elements = ['max_new_tokens', 'seed', 'temperature', 'top_p', 'top_k', 'epsilon_cutoff', 'eta_cutoff', 'typical_p', 'repetition_penalty', 'encoder_repetition_penalty', 'no_repeat_ngram_size', 'min_length', 'do_sample', 'penalty_alpha', 'num_beams', 'length_penalty', 'early_stopping', 'add_bos_token', 'ban_eos_token', 'truncation_length', 'custom_stopping_strings', 'skip_special_tokens', 'preset_menu', 'stream']
    if chat:
